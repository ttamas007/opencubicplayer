...
DLLEXTINFO_PLAYBACK_PREFIX struct linkinfostruct dllextinfo = {.name = "playgme", .desc = "OpenCP GME Player (c) 2024-'26 Stian Skjelstad", .ver = DLLVERSION, .sortindex = 95, .PluginInit = gmePluginInit, .PluginClose = gmePluginClose};
